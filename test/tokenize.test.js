...
tape('tokenizer', function(test) {
  ...
  test.deepEqual(
    tokenize('escaped \\- dash'),
    [ { type: 'TEXT',    line: 1, column: 1,  string: 'escaped - dash' },
      { type: 'END',     line: 1, column: 16, string: '' } ],
    'escaped dash character')

  test.deepEqual(
    tokenize('backslash \\\\ character'),
    [ { type: 'TEXT',    line: 1, column: 1,  string: 'backslash \\ character' },
      { type: 'END',     line: 1, column: 23, string: '' } ],
    'escaped backslash')
